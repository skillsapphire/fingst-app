...
public class ExcelHelper {
    ...
    static String[] HEADERs = { "Firm Name", "GST No", "GSTR1", "GSTR3B" };
    static String SHEET = "Filing Report";
    public static ByteArrayInputStream tutorialsToExcel(List<NotFiledDTO> notFiledDTOS) {
